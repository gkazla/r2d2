...
from r2d2.api.websocket.routes.custom_routes.custom_routes_stack import CustomWsRoutesStack
...
class WebsocketRoutesStack(Stack):
    def __init__(self, scope: Stack) -> None:
        stack_name = GlobDomain.ins.build_stack_name('WebsocketRoutes')
        ...
        self.custom_routes_stack = CustomWsRoutesStack(scope=self)
